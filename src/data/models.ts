...
export const MODEL_QUALITIES: Record<string, string[]> = {
  ...
  'wan-2.7-global-i2i': ['Standard', 'High'],
  'wan-2.7-global-i2i-pro': ['Standard', 'High', '超清'],
  'wan-2.7-global-t2i': ['Standard', 'High'],
  'grok-imagine-image-2.0': ['1K 标准', '2K 高清'],
